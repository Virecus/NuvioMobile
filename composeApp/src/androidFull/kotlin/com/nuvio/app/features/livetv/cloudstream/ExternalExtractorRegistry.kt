 ...
 * Bridges with the CloudStream library's global [extractorApis] list and
 * [loadExtractor] function. Ported from NuvioTV (Hilt removed).
 */
class ExternalExtractorRegistry {
